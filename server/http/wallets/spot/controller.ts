...
function setupDepositsCron() {
  CronManager.addJob('Pending Deposits', '*/15 * * * *', processPendingDeposits)

  CronManager.startJob('Pending Deposits')
}

function setupWithdrawalsCron() {
  CronManager.addJob(
    'Pending Withdrawals',
    '*/30 * * * *',
  ...
  CronManager.startJob('Pending Withdrawals')
}

setupDepositsCron()
setupWithdrawalsCron()
